...
require 'plugins/iceCmsPlugin/lib/model/om/BaseiceModelCmsPagePeer.php';

/**
 * Base static class for performing query operations on the tree contained by the 'cms_page' table.
 *
 * 
 *
 ...
 */
abstract class BaseiceModelCmsPageNestedSetPeer extends BaseiceModelCmsPagePeer implements NodePeer {

	/**
	 * Left column for the set
	 */
	const LEFT_COL = 'cms_page.TREE_LEFT';

	/**
	 * Right column for the set
	 */
	const RIGHT_COL = 'cms_page.TREE_RIGHT';

	/**
	 * Scope column for the set
	 */
	const SCOPE_COL = 'cms_page.TREE_SCOPE';

	/**
	 * Creates the supplied node as the root node.
	 *
	 * @param      iceModelCmsPage $node	Propel object for model
	 ...
	 * @return     iceModelCmsPage			Propel object for root node
	 */
	public static function retrieveRoot($scopeId = null, PropelPDO $con = null)
	{
		$c = new Criteria(iceModelCmsPagePeer::DATABASE_NAME);
		...
		return iceModelCmsPagePeer::doSelectOne($c, $con);
	}

	/**
	 * Inserts $child as first child of given $parent node
	 *
	 * @param      iceModelCmsPage $child	Propel object for child node
	 * @param      iceModelCmsPage $parent	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 * @param      iceModelCmsPage $sibling	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      iceModelCmsPage $parent	Propel object for given parent node
	 * @param      iceModelCmsPage $node	Propel object for given destination node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      iceModelCmsPage $node	Propel object as root node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	public static function insertRoot(NodeObject $node, PropelPDO $con = null)
	{
		...
		iceModelCmsPagePeer::insertAsParentOf(iceModelCmsPagePeer::retrieveRoot($sidv, $con), $node, $con);
	}
	 ...
	 * @param      iceModelCmsPage $child	Propel object to become child node
	 * @param      iceModelCmsPage $parent	Propel object as parent node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	...
	public static function deleteRoot($scopeId = null, PropelPDO $con = null)
	{
		...
		$root = iceModelCmsPagePeer::retrieveRoot($scopeId, $con);
		if (iceModelCmsPagePeer::getNumberOfChildren($root) == 1) {
			return iceModelCmsPagePeer::deleteNode($root, $con);
		} else {
			return false;
		}
	}
	 ...
	 * Delete $dest node
	 *
	 * @param      iceModelCmsPage $dest	Propel object node to delete
	 * @param      PropelPDO $con	Connection to use.
	 * @return     boolean		Deletion status
	 */
	public static function deleteNode(NodeObject $dest, PropelPDO $con = null)
	{
		if ($dest->getLeftValue() == 1) {
			...
			return iceModelCmsPagePeer::deleteRoot($con);
		}
	 ...
	 * @param      iceModelCmsPage $node	Propel object for source node
	 * @param      PropelPDO $con	Connection to use.
	 * @return     void
	 */
	 ...
	 *
	 * @param      iceModelCmsPage $node	Propel object for src node
	 * @param      PropelPDO $con	Connection to use.
	...
	public static function retrievePrevSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$prevSibling = iceModelCmsPagePeer::doSelectOne($c, $con);
	...
	public static function retrieveNextSibling(NodeObject $node, PropelPDO $con = null)
	{
		...
		$nextSibling = iceModelCmsPagePeer::doSelectOne($c, $con);
	...
	public static function retrieveTree($scopeId = null, PropelPDO $con = null)
	{
		...
		$stmt = iceModelCmsPagePeer::doSelectStmt($c, $con);
		if (false !== ($row = $stmt->fetch(PDO::FETCH_NUM))) {
			$omClass = iceModelCmsPagePeer::getOMClass($row, 0);
			$cls = substr('.'.$omClass, strrpos('.'.$omClass, '.') + 1);

			$key = iceModelCmsPagePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null === ($root = iceModelCmsPagePeer::getInstanceFromPool($key))) {
				$root = new $cls();
				$root->hydrate($row);
			}

			$root->setLevel(0);
			iceModelCmsPagePeer::hydrateDescendants($root, $stmt);
			iceModelCmsPagePeer::addInstanceToPool($root);
	 ...
	 *
	 * @param      iceModelCmsPage $node	Propel object for parent node
	 * @param      PropelPDO $con	Connection to use.
	 */
	public static function retrieveBranch(NodeObject $node, PropelPDO $con = null)
	{
		return iceModelCmsPagePeer::retrieveDescendants($node, $con);
	}
	...
	public static function retrieveChildren(NodeObject $node, PropelPDO $con = null)
	{
		...
		return iceModelCmsPagePeer::hydrateChildren($node, $stmt);
	}
	...
	public static function retrieveDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		return iceModelCmsPagePeer::hydrateDescendants($node, $stmt);
	}
	...
	{
		$parent = iceModelCmsPagePeer::retrieveParent($node, $con);
		$siblings = iceModelCmsPagePeer::retrieveChildren($parent, $con);
	...
	public static function retrieveParent(NodeObject $node, PropelPDO $con = null)
	{
		...
		$parent = iceModelCmsPagePeer::doSelectOne($c, $con);
	...
	{
		$children = iceModelCmsPagePeer::retrieveChildren($node);
	 ...
	 *
	 * @param      iceModelCmsPage $node	Propel object of node to create path to
	 * @param      PropelPDO $con	Connection to use.
	 ...
	 *
	 * @param      iceModelCmsPage $child	Propel object for node
	 * @param      iceModelCmsPage $parent	Propel object for node
	 * @return     bool
	 */
	 ...
	 * @param      iceModelCmsPage $node1		Propel object for node
	 * @param      iceModelCmsPage $node2		Propel object for node
	 * @return     bool
	 */
	 ...
	 *
	 * @param      iceModelCmsPage $node		Propel object for node
	 * @param      PropelPDO $con		Connection to use.
	 * @return     bool
	 */
	public static function hasParent(NodeObject $node, PropelPDO $con = null)
	{
		return iceModelCmsPagePeer::isValid(iceModelCmsPagePeer::retrieveParent($node, $con));
	}
	...
	{
		return iceModelCmsPagePeer::isValid(iceModelCmsPagePeer::retrievePrevSibling($node, $con));
	}
	...
	{
		return iceModelCmsPagePeer::isValid(iceModelCmsPagePeer::retrieveNextSibling($node, $con));
	}
	...
	public static function deleteDescendants(NodeObject $node, PropelPDO $con = null)
	{
		...
		$result = iceModelCmsPagePeer::doDelete($c, $con);
	 ...
	 *
	 * @param      int/iceModelCmsPage $node	Primary key/instance of required node
	 * @param      PropelPDO $con		Connection to use.
	...
	public static function getNode($node, PropelPDO $con = null)
	{
		if (is_object($node)) {
			...
			$object = iceModelCmsPagePeer::retrieveByPK($node, $con);
	...
	protected static function hydrateDescendants(NodeObject $node, PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = iceModelCmsPagePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null === ($child = iceModelCmsPagePeer::getInstanceFromPool($key))) {
				$child = new $cls();
				$child->hydrate($row);
			}
			...
			if ($child->hasChildren()) {
				$descendants = array_merge($descendants, iceModelCmsPagePeer::hydrateDescendants($child, $stmt));
			} else {
			...
			iceModelCmsPagePeer::addInstanceToPool($child);
	...
	protected static function updateLoadedNode(NodeObject $node, $delta, PropelPDO $con = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			...
			if (!empty($keys)) {
				...
				$criteria->add(iceModelCmsPagePeer::ID, $keys, Criteria::IN);

				$stmt = iceModelCmsPagePeer::doSelectStmt($criteria, $con);
				while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
					$key = iceModelCmsPagePeer::getPrimaryKeyHashFromRow($row, 0);
					if (null !== ($object = iceModelCmsPagePeer::getInstanceFromPool($key))) {
	 ...
	 *
	 * @param      iceModelCmsPage $node Propel object for node to update
	...
	protected static function shiftRLValues($first, $delta, PropelPDO $con = null, $scopeId = null)
	{
		...
		$whereCriteria = new Criteria(iceModelCmsPagePeer::DATABASE_NAME);
		...
		$valuesCriteria = new Criteria(iceModelCmsPagePeer::DATABASE_NAME);
		$valuesCriteria->add(
			self::LEFT_COL,
...
} // BaseiceModelCmsPageNestedSetPeer
